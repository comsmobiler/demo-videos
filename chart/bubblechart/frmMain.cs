...
partial class frmMain
{
    ...
    /// </summary>
    /// <remarks></remarks>
    Smobiler.Utility.Encoding.Windows.Forms.QrCodeImgControl qrcodeControl;
    /// <summary>
    /// Smobiler服务
    /// </summary>
    /// <remarks></remarks>
    ...
    private void StartServer()
    {
        ...
        {
            //服务起始界面
            server.StartUpForm = typeof(bubblechart.SmobilerForm1);
            //服务TCP端口，默认为2323   
    ...
    private void btnSetting_Click(object sender, EventArgs e)
    {
        try
        {
            frmSetting setting = new frmSetting(server.Setting);
